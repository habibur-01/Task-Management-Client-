        ...
        <div className="w-64 bg-slate-300 min-h-screen px-4 py-5 relative">
            ...
            <div>
                <ul className="space-y-6">
                    ...
                    <li><NavLink to="/signup"><span className={`flex items-center gap-2 ${user?'hidden':'block'}`}><img src={allTask} alt="" className="w-7 h-6 object-cover" /> Signup </span></NavLink></li>
                    <li><NavLink to="/login"><span className={`flex items-center gap-2 ${user?'hidden':'block'}`}><img src={allTask} alt="" className="w-7 h-6 object-cover" /> Login </span></NavLink></li>
                    <li onClick={handleLogOut}><NavLink to=""><span className={`flex items-center gap-2 ${user?'block':'hidden'}`}><img src={allTask} alt="" className="w-7 h-6 object-cover" /> Log out </span></NavLink></li>
                </ul>
            </div>
